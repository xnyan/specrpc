...
public class ClientStubGrpc {
  ...
  public RcServiceBlockingStub getBlockingStub(String serverId) {
    ManagedChannel channel = this.getChannelToServer(serverId);
    RcServiceBlockingStub rcServiceStub = RcServiceGrpc.newBlockingStub(channel);
