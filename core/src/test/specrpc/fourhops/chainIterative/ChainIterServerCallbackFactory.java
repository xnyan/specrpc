...
public class ChainIterServerCallbackFactory implements SpecRpcCallbackFactory {
  ...
  public ChainIterServerCallbackFactory(int index, RpcSignature methodSignature, String requestValue,
  ...
  public SpecRpcCallbackObject createCallback() {
    return new ChainIterServerCallback(this.index, this.methodSignature, this.requestValue, this.predictedValues);
  }
