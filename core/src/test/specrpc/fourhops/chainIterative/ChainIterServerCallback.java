...
//import spec_rpc.exception.NoClientStubException;
...
public class ChainIterServerCallback extends SpecRpcCallbackObject {
  ...
  public ChainIterServerCallback(int index, RpcSignature methodSignature, String requestValue,
  ...
  public Object run(Object rpcReturnValue) throws SpeculationFailException, InterruptedException {
    ...
    try {
      if (this.indexInIterativePattern > 1) {
        // Iterative calls
        SpecRpcClientStub srvStub = specRPCFacade.bind(ChainIterTest.SERVER_IDENTITY, this.methodSignature);
        SpecRpcFuture future = srvStub.call(this.predictedValues, new ChainIterServerCallbackFactory(
