...
public class ChainIterServiceHostFactory implements SpecRpcHostFactory {

  public ChainIterServiceHostFactory() {

  }

  @Override
  public String getRpcHostClassName() {
    return ChainIterServiceHost.class.getName();
  }

  @Override
  public SpecRpcHostObject getRpcHostObject() {
    return new ChainIterServiceHost();
  }
