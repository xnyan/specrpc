...
public class OneHopServiceHostFactory implements SpecRpcHostFactory {

  public OneHopServiceHostFactory() {

  }

  @Override
  public String getRpcHostClassName() {
    return OneHopServiceHost.class.getName();
  }

  @Override
  public SpecRpcHostObject getRpcHostObject() {
    return new OneHopServiceHost();
  }
}
