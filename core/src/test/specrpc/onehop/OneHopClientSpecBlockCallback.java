...
public class OneHopClientSpecBlockCallback extends OneHopClientCallback {

  protected AtomicInteger passSpecBlockNum;
  protected AtomicInteger failSpecBlockNum;

  public OneHopClientSpecBlockCallback(Vector<String> rpcReturnValues, CyclicBarrier allCallbacksBarrier,
      AtomicInteger passSpecBlockNum, AtomicInteger failSpecBlockNum) {
    super(rpcReturnValues, allCallbacksBarrier);
