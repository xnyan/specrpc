...
public class IterServiceHostFactory implements SpecRpcHostFactory {

  public IterServiceHostFactory() {

  }

  @Override
  public String getRpcHostClassName() {
    return IterServiceHost.class.getName();
  }

  @Override
  public SpecRpcHostObject getRpcHostObject() {
    return new IterServiceHost();
  }
