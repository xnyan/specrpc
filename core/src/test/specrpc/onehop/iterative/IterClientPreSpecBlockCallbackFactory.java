...
public class IterClientPreSpecBlockCallbackFactory extends IterClientSpecBlockCallbackFactory {

  public IterClientPreSpecBlockCallbackFactory(int index, RpcSignature methodSignature, String requestValue,
  ...
  public SpecRpcCallbackObject createCallback() {
    return new IterClientPreSpecBlockCallback(this.index, this.methodSignature, this.requestValue, this.predictedValues,
