...
public class IterClientPreExceptionCallback extends IterClientCallback {

  public IterClientPreExceptionCallback(int index, RpcSignature methodSignature, String requestValue,
  ...
  public Object run(Object rpcReturnValue) throws SpeculationFailException, InterruptedException {
    try {
      ...
      return IterClient.CALLBACK_RESULT_PREFIX + this.indexInIterativePattern + " " + e.getMessage();
    }
