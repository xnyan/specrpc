...
public class IterClientPreSpecBlockCallback extends IterClientSpecBlockCallback {

  public IterClientPreSpecBlockCallback(int index, RpcSignature methodSignature, String requestValue,
    ...
    try {
      ...
      if (this.indexInIterativePattern > 1) {// iterative calls
        ...
        SpecRpcFuture future = srvStub.call(this.predictedValues,
            new IterClientPostSpecBlockCallbackFactory(this.indexInIterativePattern - 1, this.methodSignature,
