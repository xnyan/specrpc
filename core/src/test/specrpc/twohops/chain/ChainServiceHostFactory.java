...
public class ChainServiceHostFactory implements SpecRpcHostFactory {

  public ChainServiceHostFactory() {

  }

  @Override
  public String getRpcHostClassName() {
    return ChainServiceHost.class.getName();
  }

  @Override
  public SpecRpcHostObject getRpcHostObject() {
    return new ChainServiceHost();
  }
}
