...
public class ChainServerSpecReturnCallbackFactory implements SpecRpcCallbackFactory {

  public ChainServerSpecReturnCallbackFactory() {

  }

  @Override
  public SpecRpcCallbackObject createCallback() {
    return new ChainServerSpecReturnCallback();
  }
