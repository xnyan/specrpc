...
public class ChainServerExceptionCallback extends ChainClientSpecBlockCallback {

  public ChainServerExceptionCallback(CyclicBarrier allCallbacksBarrier, AtomicInteger passSpecBlockNum,
  ...
  public Object run(Object rpcReturnValue) throws SpeculationFailException, InterruptedException {
    ...
    try {
      specRPCFacade
          .throwNonSpecExceptionToClient(ChainServiceMessages.MID_SERVER_EXCEPTION_PREFIX + rpcReturnValue.toString());
    ...
    return ChainServiceMessages.MID_SERVER_EXCEPTION_PREFIX + rpcReturnValue.toString();
  }
