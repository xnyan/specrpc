...
public class ChainServerReturnCallbackFactory implements SpecRpcCallbackFactory {

  public ChainServerReturnCallbackFactory() {

  }

  @Override
  public SpecRpcCallbackObject createCallback() {
    return new ChainServerReturnCallback();
  }
