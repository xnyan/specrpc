...
public class ChainServerMultiSpecReturnCallback extends ChainServerReturnCallback {
  ...
  public Object run(Object rpcReturnValue) throws SpeculationFailException, InterruptedException {
    ...
    try {
      ...
      specRPCFacade
          .specReturn(ChainServiceMessages.MID_SERVER_SPEC_RESPONSE_PREFIX_2 + rpcReturnValue.toString());

      this.doWork();

      specRPCFacade
          .specReturn(ChainServiceMessages.MID_SERVER_SPEC_RESPONSE_PREFIX_3 + rpcReturnValue.toString());
      specRPCFacade
          .specReturn(ChainServiceMessages.MID_SERVER_SPEC_RESPONSE_PREFIX_4 + rpcReturnValue.toString());
